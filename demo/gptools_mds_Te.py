...
a1.errorbar(R_mid_ETS_w, Te_ETS_w, xerr=dev_R_mid_ETS_w, yerr=dev_Te_ETS_w, fmt='k.', label=None)#, label='ETS')
a1.errorbar(R_mid_FRC_w, Te_FRC_w, xerr=dev_R_mid_FRC_w, yerr=dev_Te_FRC_w, fmt='g.', label='ECE')
a1.errorbar(R_mid_GPC2_w, Te_GPC2_w, xerr=dev_R_mid_GPC2_w, yerr=dev_Te_GPC2_w, fmt='g.', label=None)#, label='GPC2')
a1.errorbar(R_mid_GPC_w, Te_GPC_w, xerr=dev_R_mid_GPC_w, yerr=dev_Te_GPC_w, fmt='g.', label=None)#, label='GPC')
