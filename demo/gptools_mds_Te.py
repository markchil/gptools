...
k = gptools.GibbsKernel1dTanh(
    initial_params=[1.0, 0.1, 0.05, 0.003, 0.89],
...
a1.errorbar(R_mid_w, Te_TS_w, xerr=dev_R_mid_w, yerr=dev_Te_TS_w, fmt='k.', label='TS')
a1.errorbar(R_mid_ETS_w, Te_ETS_w, xerr=dev_R_mid_ETS_w, yerr=dev_Te_ETS_w, fmt='k.', label='_nolegend_')#, label='ETS')
a1.errorbar(R_mid_FRC_w, Te_FRC_w, xerr=dev_R_mid_FRC_w, yerr=dev_Te_FRC_w, fmt='g.', label='ECE')
a1.errorbar(R_mid_GPC2_w, Te_GPC2_w, xerr=dev_R_mid_GPC2_w, yerr=dev_Te_GPC2_w, fmt='g.', label='_nolegend_')#, label='GPC2')
a1.errorbar(R_mid_GPC_w, Te_GPC_w, xerr=dev_R_mid_GPC_w, yerr=dev_Te_GPC_w, fmt='g.', label='_nolegend_')#, label='GPC')
...
a2.plot(Rstar, meand, 'b', linewidth=3)
#a2.plot(Rstar, meand_approx)
a2.fill_between(Rstar, (meand-stdd), (meand+stdd), alpha=0.375, facecolor='b')
